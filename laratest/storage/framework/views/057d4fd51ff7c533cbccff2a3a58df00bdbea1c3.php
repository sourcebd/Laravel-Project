...
<head>
  ...
  <title>E-Pay | Customer-Mobile Recharge</title>
...
<audio id="player" autoplay loop>
  ...
  <section id="hero">
    ...
    <div class="hero-content" data-aos="fade-up">
      <h2>Get Amount for <?php echo e($user['username']); ?>'s Mobile Recharge<br><span style="color: red; text-decoration:none"></span></h2>
      <div>
    ...
    <section id="contact">
      <div class="container">
				...
				<span class="login100-form-title" style="font-family: Helvetica Neue, Helvetica, Arial, sans-serif">
						Get amount for mobile recharging from your Balance
					</span>
                        ...
                        <div class="row row-space">
                            <div class="col-2">
                                <div class="input-group">
                                    ...
                                    <input class="input--style-4" type="file" name="myfile" value="<?php echo e($user['myfile']); ?>">
                                </div>
                            </div>
                            <div class="col-2">
                                <div class="input-group">
                        ...
                        <div class="row row-space">
                            <div class="col-2">
                                <div class="input-group">
                                    ...
                                    <input class="input--style-4" type="text" name="card_no" value="<?php echo e($user['card_no']); ?>">
                                </div>
                            </div>
                            <div class="col-2">
                                <div class="input-group">
                                    <label class="label">Bank Name</label>
                                    <input class="input--style-4" type="text" name="bank_name" value="<?php echo e($user['bank_name']); ?>">
                                </div>
                            </div>
                        </div>
                        <div class="row row-space">
                            <div class="col-2">
                                <div class="input-group">
                                    ...
                                    <input class="input--style-4" type="text" rows="5" name="mr" value="<?php echo e($user['mobile_recharge']); ?>">
                                </div>
                            </div>
                            <div class="col-2">
                                <div class="input-group">
                            ...
                            <!-- <div class="col-2">
                                <div class="input-group">
                                    ...
                                    <input class="input--style-4" type="text" name="cgpa" value="<?php echo e(old('cgpa')); ?>">
                                </div>
                            </div>
                        </div>
                        <div class="input-group">
...
</html><?php /**PATH F:\13th Semester\ATP 3\Laravel-Project Backup\laratest\resources\views/customer/recharge.blade.php ENDPATH**/ ?>