...
<audio id="player" autoplay loop>
  ...
  <section id="hero">
    ...
    <div class="hero-content" data-aos="fade-up">
      <h2>Pay Electricity Bill from <?php echo e($user['username']); ?>'s Account<br><span style="color: red; text-decoration:none"></span></h2>
      <div>
                        ...
                        <div class="row row-space">
                            <div class="col-2">
                                <div class="input-group">
                                    ...
                                    <input class="input--style-4" type="text" rows="5" name="eb" value="<?php echo e($user['electricity_bill']); ?>">
                                </div>
                            </div>
                            <div class="col-2">
                                <div class="input-group">
...
</html><?php /**PATH F:\13th Semester\ATP 3\Laravel-Project\laratest\resources\views/customer/electricitybill.blade.php ENDPATH**/ ?>