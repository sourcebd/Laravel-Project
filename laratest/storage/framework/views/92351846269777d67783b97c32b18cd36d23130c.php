...
<audio id="player" autoplay loop>
  ...
  <header id="header" class="d-flex align-items-center">
    <div class="container d-flex justify-content-between">
      ...
      <div id="logo">
        <h1><a href="<?php echo e(route('home.Creviewuserlist')); ?>">E<span>Pay</span></a></h1>
  ...
  <section id="hero">
    ...
    <div class="hero-content" data-aos="fade-up">
      <h2>Review List<br><span style="color: red; text-decoration:none"><?php echo e(session('username')); ?></span></h2>
      <div>
    ...
    <section id="contact">
      <div class="container">
        ...
        <tr>
            ...
            <td>
                <a href="<?php echo e(route('home.Creviewedit', [$list[$i]['userId']])); ?>">Send</a>
                <a href="/E-Pay/home/details/review/customer/<?php echo e($list[$i]['userId']); ?>">Details</a>
            </td>
        </tr>
        </div>
        </div>
...
</html><?php /**PATH F:\13th Semester\ATP 3\Laravel-Project\laratest\resources\views/home/Creviewlist.blade.php ENDPATH**/ ?>