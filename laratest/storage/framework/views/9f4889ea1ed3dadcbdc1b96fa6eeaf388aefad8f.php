          ...
          <li class="dropdown"><a href="#"><span>Customer</span> <i class="bi bi-chevron-down"></i></a>
            <ul>
              <li class="dropdown"><a href="#"><span>Account Access</span> <i class="bi bi-chevron-right"></i></a>
                <ul>
                  <li><a href="<?php echo e(route('login.customer')); ?>">Login</a></li>
                  <li><a href="<?php echo e(route('registration.customer')); ?>">Registration</a></li>
                </ul>
              </li>
            </ul>
          </li>
                        ...
                        <div class="row row-space">
                            <div class="col-2">
                                <div class="input-group">
                                    ...
                                    <div class="input-group-icon">
                                        <input class="input--style-4 js-datepicker" type="date" name="dom" value="<?php echo e(old('dom')); ?>">
                            ...
                            <div class="col-2">
                                <div class="input-group">
                                    ...
                                    <input class="input--style-4" type="text" name="subject" value="<?php echo e(old('subject')); ?>">
                                </div>
                            </div>
                        </div>
                        <div class="row row-space">
                                <div class="input-group">
                                    ...
                                    <input class="input--style-4" type="text" rows="5" name="message" value="<?php echo e(old('message')); ?>">
                                </div>
...
<br><br>
        <div style="width:50%; margin-left:25%; font-size:20px ; text-transform: none; text-align: center">
          ...
          <div class="sent-message"><?php echo e(session('msg')); ?></div>
        </div>
...
</html><?php /**PATH F:\13th Semester\ATP 3\Laravel-Project Backup\laratest\resources\views/Main.blade.php ENDPATH**/ ?>