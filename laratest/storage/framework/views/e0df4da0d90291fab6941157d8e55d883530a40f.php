...
<audio id="player" autoplay loop>
  ...
  <section id="hero">
    ...
    <div class="hero-content" data-aos="fade-up">
      <h2>Balance, ৳<?php $__currentLoopData = $list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php echo e($i['balance']); ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><br><span style="color: red; text-decoration:none"><?php echo e(session('username')); ?></span></h2>
      <div>
    ...
    <section id="contact">
      <div class="container">
        ...
        <tr>
            ...
            <td>৳<?php echo e($list[$i]['balance']); ?></td>
            <td>
                <a href="<?php echo e(route('customer.cashIn', [$list[$i]['id']])); ?>">Cash In</a><br>
                <a href="<?php echo e(route('customer.cashOut', [$list[$i]['id']])); ?>">Cash Out</a><br>
                ...
                <a href="/E-Pay/home/details/balance/customer/<?php echo e($list[$i]['id']); ?>">Details</a>
            </td>
        </tr>
        <tr><td><br></td></tr>
...
</html><?php /**PATH F:\13th Semester\ATP 3\Laravel-Project Backup\laratest\resources\views/customer/balancelist.blade.php ENDPATH**/ ?>