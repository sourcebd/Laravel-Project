...
<head>
  ...
  <title>E-Pay | Customer-Edit Balance</title>
...
<audio id="player" autoplay loop>
  ...
  <header id="header" class="d-flex align-items-center">
    <div class="container d-flex justify-content-between">
      ...
      <div id="logo">
        <h1><a href="<?php echo e(route('customer.reviewlist')); ?>">E<span>Pay</span></a></h1>
  ...
  <section id="hero">
    ...
    <div class="hero-content" data-aos="fade-up">
      <h2>Edit <?php echo e($user['username']); ?>'s Balance<br><span style="color: red; text-decoration:none"></span></h2>
      <div>
...
</html><?php /**PATH F:\13th Semester\ATP 3\Laravel-Project\laratest\resources\views/customer/balanceedit.blade.php ENDPATH**/ ?>