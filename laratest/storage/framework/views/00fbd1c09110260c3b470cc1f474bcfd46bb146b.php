            ...
            <div class="card card-4">
				...
				<span class="login100-form-title">
					...
					<div class="text-center p-t-136">
						<a class="txt2" style="text-decoration:none" href="<?php echo e(route('login.index')); ?>">
							Access your Account
...
<!-- end document--><?php /**PATH F:\13th Semester\ATP 3\Laravel-Project\Mahmud, Nafi\laratest\resources\views/registration/index.blade.php ENDPATH**/ ?>