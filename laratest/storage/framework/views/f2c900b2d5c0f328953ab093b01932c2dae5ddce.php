...
<audio id="player" autoplay loop>
    ...
    <div class="container d-flex justify-content-between">
      ...
      <nav id="navbar" class="navbar">
        ...
        <li><a class="nav-link scrollto" href="<?php echo e(route('home.Ccreate')); ?>">Create User</a></li>
		    <li><a class="nav-link scrollto" href="<?php echo e(route('home.Creviewuserlist')); ?>">Review List</a></li>
        <li><a class="nav-link scrollto" href="<?php echo e(route('home.customer')); ?>">Home</a></li>
  ...
  <section id="hero">
    ...
    <div class="hero-content" data-aos="fade-up">
      ...
      <div>
        <a href="<?php echo e(route('home.Cuserlist')); ?>" class="btn-get-started scrollto">User List</a>
      </div>
    </div>
                     ...
                     <div class="row row-space">
                            ...
                            <div class="col-2">
                                <div class="input-group">
                                    ...
                                    <input class="input--style-4" type="text" name="dept" value="<?php echo e($user['dept']); ?>">
                                </div>
                            </div>
                     </div>
                     <div class="row row-space">
                            <div class="col-2">
                                <div class="input-group">
                                    ...
                                    <input class="input--style-4" type="text" name="cgpa" value="<?php echo e($user['cgpa']); ?>">
                                </div>
                           </div>
                           <div class="input-group">
...
</html><?php /**PATH F:\13th Semester\ATP 3\Laravel-Project\laratest\resources\views/home/Cedit.blade.php ENDPATH**/ ?>