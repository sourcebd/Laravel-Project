...
<h1 style="color: green">Customer Balance Details <br> <?php echo e(session('username')); ?> </h1>
    ...
    <center>
        ...
        <h2 style="font-family: Arial, Helvetica, sans-serif;">All Transactions of last 1 Days</h2>
    </center>
    ...
    <table width=100% border="1" style="text-align:center">
        ...
        <tr>
            ...
            <tr>
                ...
                <a href="<?php echo e(route('balancePDF', [$i->id])); ?>">Details</a>
                <td><a href="<?php echo e(action('CPDFController@printPDF', [$i['id']])); ?>">Download PDF</a></td>
            </tr>
...
</div><?php /**PATH F:\13th Semester\ATP 3\Laravel-Project\laratest\resources\views/customer/pdflist.blade.php ENDPATH**/ ?>