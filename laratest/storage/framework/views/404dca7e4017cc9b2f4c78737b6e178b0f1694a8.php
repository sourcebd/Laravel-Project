...
<head>
  ...
  <title>E-Pay | Customer-Edit</title>
...
<audio id="player" autoplay loop>
  ...
  <header id="header" class="d-flex align-items-center">
    <div class="container d-flex justify-content-between">
      ...
      <div id="logo">
        <h1><a href="<?php echo e(route('customer.userlist')); ?>">E<span>Pay</span></a></h1>
      ...
      <nav id="navbar" class="navbar">
        ...
        <li><a class="nav-link scrollto" href="<?php echo e(route('customer.balancelist')); ?>">Balance</a></li>
        <li><a class="nav-link scrollto" href="<?php echo e(route('customer.purchaselist')); ?>">Purchase</a></li>
        <li><a class="nav-link scrollto" href="<?php echo e(route('customer.reviewlist')); ?>">Review</a></li>
        <li><a class="nav-link scrollto" href="<?php echo e(route('customer.messagelist')); ?>">Message</a></li>
  ...
  <section id="hero">
    ...
    <div class="hero-content" data-aos="fade-up">
      <h2>Edit <?php echo e($user['name']); ?>'s details<br><span style="color: red; text-decoration:none"></span></h2>
      <div>
        ...
        <form method="POST" enctype="multipart/form-data">
					<?php echo csrf_field(); ?>
                        <div class="row row-space">
                            <div class="col-2">
                                <div class="input-group">
                                    ...
                                    <input class="input--style-4" type="text" name="username" value="<?php echo e($user['username']); ?>">
                                </div>
                            </div>
                            <div class="col-2">
                                <div class="input-group">
                                    <label class="label">Password</label>
                                    <input class="input--style-4" type="password" name="password" value="<?php echo e($user['password']); ?>">
                                </div>
                            </div>
                            <div class="col-2">
                                <div class="input-group">
                                    <label class="label">Name</label>
                                    <input class="input--style-4" type="text" name="name" value="<?php echo e($user['name']); ?>">
                                </div>
                            </div>
                            <div class="col-2">
                                <div class="input-group">
                                    ...
                                    <div class="input-group-icon">
                                        <input class="input--style-4 js-datepicker" type="date" name="dob" value="<?php echo e($user['dob']); ?>">
                                ...
                                <div class="input-group">
                                    ...
                                    <input class="input--style-4" type="text" name="email" value="<?php echo e($user['email']); ?>">
                                </div>
                        <div class="row row-space">
                            <div class="col-2">
                                <div class="input-group">
                                    <label class="label">Father/Spouse Name</label>
                                    <input class="input--style-4" type="text" name="father" value="<?php echo e($user['father_name']); ?>">
                                </div>
                            </div>
                            <div class="col-2">
                                <div class="input-group">
                                    <label class="label">Mother Name</label>
                                    <input class="input--style-4" type="text" name="mother" value="<?php echo e($user['mother_name']); ?>">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row row-space">
                            <div class="col-2">
                                <div class="input-group">
                                    ...
                                    <input class="input--style-4" type="text" name="addr" value="<?php echo e($user['address']); ?>">
                                </div>
                            </div>
                            <div class="col-2">
                                <div class="input-group">
                                    <label class="label">Phone Number</label>
                                    <input class="input--style-4" type="text" name="phone" value="<?php echo e($user['phone']); ?>">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-2">
                            ...
                            <select name='blood'>
                                <option value="A+" <?php if($user['blood_group'] == 'A+'): ?> selected <?php endif; ?> > A+ </option>
                                <option value="B+"  <?php if($user['blood_group'] == 'B+'): ?> selected <?php endif; ?> > B+ </option>
                                <option value="O-" <?php if($user['blood_group'] == 'O-'): ?> selected <?php endif; ?> > O- </option>
                                <option value="AB+"  <?php if($user['blood_group'] == 'AB+'): ?> selected <?php endif; ?> > AB+ </option>
	                          </select>
                        ...
                        <div class="input-group">
                            ...
                            <div class="rs-select2 js-select-simple select--no-search">
                            <select name='type'>
                                <option value="Customer" <?php if($user['type'] == 'Customer'): ?> selected <?php endif; ?> > Customer </option>
                                <option value="Admin"  <?php if($user['type'] == 'Admin'): ?> selected <?php endif; ?> > Admin </option>
                                <option value="Service Provider" <?php if($user['type'] == 'Service Provider'): ?> selected <?php endif; ?> > Service Provider </option>
                                <option value="Desk Manager"  <?php if($user['type'] == 'Desk Manager'): ?> selected <?php endif; ?> > Desk Manager </option>
	                          </select>
                                <div class="select-dropdown"></div>
                            </div>
                        </div>
                        ...
                        <div class="col-2">
                                <div class="input-group">
                                    ...
                                    <input class="input--style-4" type="text" name="nid" value="<?php echo e($user['nid_no']); ?>">
                                </div>
                        </div>
                        ...
                        <div class="row row-space">
                            <div class="col-2">
                                <div class="input-group">
                                    ...
                                    <input class="input--style-4" type="file" name="myfile" value="<?php echo e($user['profile_img']); ?>">
                                </div>
                            </div>
...
</html><?php /**PATH F:\13th Semester\ATP 3\Laravel-Project\laratest\resources\views/customer/edit.blade.php ENDPATH**/ ?>