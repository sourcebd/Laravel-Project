...
<head>
  ...
  <title>E-Pay | Customer-Balance Create</title>
...
<audio id="player" autoplay loop>
  ...
  <header id="header" class="d-flex align-items-center">
    <div class="container d-flex justify-content-between">
      ...
      <div id="logo">
        <h1><a href="<?php echo e(route('customer.balancecreate')); ?>">E<span>Pay</span></a></h1>
  ...
  <section id="hero">
    ...
    <div class="hero-content" data-aos="fade-up">
      <h2>Create Balance<br><span style="color: red; text-decoration:none"><?php echo e(session('username')); ?></span></h2>
      <div>
    ...
    <section id="contact">
      <div class="container">
				...
				<span class="login100-form-title" style="font-family: Helvetica Neue, Helvetica, Arial, sans-serif">
						After creating balance check out if the details of your Balance are absolutely correct
					</span>
                        ...
                        <div class="row row-space">
                            <div class="col-2">
                                <div class="input-group">
                                    ...
                                    <input class="input--style-4" type="file" name="myfile" value="<?php echo e(old('myfile')); ?>">
                                </div>
                            </div>
                            <div class="col-2">
                                <div class="input-group">
                        ...
                        <div class="row row-space">
                            <div class="col-2">
                                <div class="input-group">
                                    ...
                                    <input class="input--style-4" type="text" name="card_no" value="<?php echo e(old('card_no')); ?>">
                                </div>
                            </div>
                            <div class="col-2">
                                <div class="input-group">
                                    <label class="label">Bank Name</label>
                                    <input class="input--style-4" type="text" name="bank_name" value="<?php echo e(old('bank_name')); ?>">
                                </div>
                            </div>
                        </div>
                        <div class="row row-space">
                            <div class="col-2">
                                <div class="input-group">
                                    ...
                                    <input class="input--style-4" type="text" rows="5" name="add" value="<?php echo e(old('add')); ?>">
                                </div>
                            </div>
                            <div class="col-2">
                                <div class="input-group">
...
</html><?php /**PATH F:\13th Semester\ATP 3\Laravel-Project\laratest\resources\views/customer/balancecreate.blade.php ENDPATH**/ ?>