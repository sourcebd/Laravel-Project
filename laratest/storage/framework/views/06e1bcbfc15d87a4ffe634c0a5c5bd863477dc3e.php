...
<audio id="player" autoplay loop>
  ...
  <header id="header" class="d-flex align-items-center">
    <div class="container d-flex justify-content-between">
      ...
      <nav id="navbar" class="navbar">
        <ul>
        <!-- <li><a class="nav-link scrollto" href="<?php echo e(route('customer.create')); ?>">Create Customer</a></li> -->
        <li><a class="nav-link scrollto" href="<?php echo e(route('customer.reviewcreate')); ?>">Create Review</a></li>
        <li><a class="nav-link scrollto" href="<?php echo e(route('customer.reviewlist')); ?>">Review List</a></li>
  ...
  <section id="hero">
    ...
    <div class="hero-content" data-aos="fade-up">
      <h2>Delete <?php echo e($user['name']); ?>'s details<br><span style="color: red; text-decoration:none"></span></h2>
      <div>
        <a href="<?php echo e(route('customer.userlist')); ?>" class="btn-get-started scrollto">Customer Profile</a>
      </div>
    </div>
...
</html><?php /**PATH F:\13th Semester\ATP 3\Laravel-Project\laratest\resources\views/customer/delete.blade.php ENDPATH**/ ?>