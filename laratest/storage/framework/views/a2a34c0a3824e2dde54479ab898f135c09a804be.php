			...
			<div class="wrap-login100">
				...
				<form class="login100-form validate-form" method="post">
					...
					<div class="text-center p-t-136">
						<a class="txt2" href="<?php echo e(route('registration.index')); ?>">
							Create your Account
...
</html><?php /**PATH F:\13th Semester\ATP 3\Laravel-Project\Mahmud, Nafi\laratest\resources\views/login/index.blade.php ENDPATH**/ ?>