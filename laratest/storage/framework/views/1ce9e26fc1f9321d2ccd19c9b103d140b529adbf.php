...
<head>
  ...
  <title>E-Pay | Customer-Upload Excel</title>
...
<audio id="player" autoplay loop>
  ...
  <section id="hero">
    ...
    <div class="hero-content" data-aos="fade-up">
      <h2>Upload Excel for <?php echo e(session('username')); ?>'s Balance<br><span style="color: red; text-decoration:none"></span></h2>
      <div>
        <a href="<?php echo e(route('downloadExcel')); ?>" class="btn-get-started scrollto">Download Excel</a>
      </div>
    </div>
                        ...
                        <div class="row row-space">
                            <div class="col-2">
                                <div class="input-group">
                                    <label class="label">Enter File</label>
                                    <input class="input--style-4" type="file" name="file" value="<?php echo e(old('file')); ?>">
                                </div>
                            </div>
...
</html><?php /**PATH F:\13th Semester\ATP 3\Laravel-Project\laratest\resources\views/customer/uploadExcelview.blade.php ENDPATH**/ ?>