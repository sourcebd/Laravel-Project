...
<audio id="player" autoplay loop>
  ...
  <section id="hero">
    ...
    <div class="hero-content" data-aos="fade-up">
      <h2>User List<br><span style="color: red; text-decoration:none"><?php echo e(session('username')); ?></span></h2>
      <div>
    ...
    <section id="contact">
      <div class="container">
        ...
        <tr>
            ...
            <td>
                <a href="<?php echo e(route('home.Cedit', [$list[$i]['userId']])); ?>">Edit</a>
                <a href="/E-Pay/home/delete/customer/<?php echo e($list[$i]['userId']); ?>">Delete</a>
        ...
        <div class="row contact-info">
          ...
          <div class="col-md-4">
            <div class="contact-email">
              ...
              <h3>Email</h3>
              <p><a href="epay@gmail.com">EPay@gmail.com</a></p>
            </div>
          </div>
...
</html><?php /**PATH F:\13th Semester\ATP 3\Laravel-Project\laratest\resources\views/home/Clist.blade.php ENDPATH**/ ?>