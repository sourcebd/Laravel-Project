...
<audio id="player" autoplay loop>
  ...
  <header id="header" class="d-flex align-items-center">
    <div class="container d-flex justify-content-between">
      ...
      <div id="logo">
        <h1><a href="<?php echo e(route('customer.create')); ?>">E<span>Pay</span></a></h1>
  ...
  <section id="hero">
    ...
    <div class="hero-content" data-aos="fade-up">
      <h2>Send Review<br><span style="color: red; text-decoration:none"><?php echo e(session('username')); ?></span></h2>
      <div>
					...
					<?php echo csrf_field(); ?>
                        <div class="row row-space">
                            ...
                            <div class="col-2">
                                <div class="input-group">
                                    ...
                                    <input class="input--style-4" type="text" rows="5" name="username" value="<?php echo e(old('username')); ?>">
                                </div>
                            </div>
                          </div>
                        <div class="row row-space">
                            <div class="col-2">
                                <div class="input-group">
                                    ...
                                    <div class="input-group-icon">
                                        <input class="input--style-4 js-datepicker" type="date" name="dor" value="<?php echo e(old('dor')); ?>">
                        ...
                        <div class="row row-space">
                                <div class="input-group">
                                    ...
                                    <input class="input--style-4" type="text" rows="5" name="feedback" value="<?php echo e(old('feedback')); ?>">
                                </div>
...
</html><?php /**PATH F:\13th Semester\ATP 3\Laravel-Project Backup\laratest\resources\views/customer/reviewcreate.blade.php ENDPATH**/ ?>