...
<audio id="player" autoplay loop>
  ...
  <section id="hero">
    ...
    <div class="hero-content" data-aos="fade-up">
      <h2>Profile<br><span style="color: red; text-decoration:none"><?php echo e(session('username')); ?></span></h2>
      <div>
    ...
    <!-- ======= Services Section ======= -->
      <div class="container" data-aos="fade-up">
        <div class="section-header">
          <h2><?php for($i=0; $i < count($list); $i++): ?><?php echo e($list[$i]['name']); ?><?php endfor; ?></h2>
        </div>
    ...
    <section id="contact">
      <div class="container">
        ...
        <tr>
            ...
            <td><?php echo e($list[$i]['name']); ?></td>
            <td><?php echo e($list[$i]['type']); ?></td>
            <td>
                <a href="<?php echo e(route('customer.edit', [$list[$i]['userId']])); ?>">Edit</a><br>
                <a href="/E-Pay/home/delete/customer/<?php echo e($list[$i]['userId']); ?>">Delete</a><br>
                <a href="/E-Pay/home/details/customer/<?php echo e($list[$i]['userId']); ?>">Details</a>
            </td>
        </tr>
        <tr><td><br></td></tr>
...
<!-- ------------------------------------------------ -->
    ...
    <section id="contact">
      <div class="container">
        ...
        <tr>
            <td><?php echo e($name[$i]['userId']); ?></td>
            <td><?php echo e($name[$i]['username']); ?></td>
            <td><?php echo e($name[$i]['name']); ?></td>
            <td><?php echo e($name[$i]['father_name']); ?></td>
            <td><?php echo e($name[$i]['mother_name']); ?></td>
            <td><?php echo e($name[$i]['dob']); ?></td>
            <td><?php echo e($name[$i]['gender']); ?></td>
            <td><?php echo e($name[$i]['blood_group']); ?></td>
            <td><?php echo e($name[$i]['type']); ?></td>
...
</html><?php /**PATH F:\13th Semester\ATP 3\Laravel-Project Backup\laratest\resources\views/customer/list.blade.php ENDPATH**/ ?>