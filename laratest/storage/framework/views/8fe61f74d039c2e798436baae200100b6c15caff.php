...
<head>
  ...
  <title>E-Pay | Customer-Cash In</title>
...
<audio id="player" autoplay loop>
  ...
  <header id="header" class="d-flex align-items-center">
    <div class="container d-flex justify-content-between">
      ...
      <div id="logo">
        <h1><a href="<?php echo e(route('customer.balancelist')); ?>">E<span>Pay</span></a></h1>
  ...
  <section id="hero">
    ...
    <div class="hero-content" data-aos="fade-up">
      <h2>Cash In for <?php echo e($user['username']); ?>'s Account<br><span style="color: red; text-decoration:none"></span></h2>
      <div>
                        ...
                        <div class="row row-space">
                            <div class="col-2">
                                <div class="input-group">
                                    ...
                                    <input class="input--style-4" type="text" rows="5" name="add" value="<?php echo e($user['added']); ?>">
                                </div>
                            </div>
                            <div class="col-2">
                                <div class="input-group">
...
</html><?php /**PATH F:\13th Semester\ATP 3\Laravel-Project\laratest\resources\views/customer/cashIn.blade.php ENDPATH**/ ?>