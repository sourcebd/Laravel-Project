...
<head>
  ...
  <title>E-Pay | Customer-Message</title>
...
<audio id="player" autoplay loop>
  ...
  <section id="hero">
    ...
    <div class="hero-content" data-aos="fade-up">
      <h2>Message to Admin<br><span style="color: red; text-decoration:none"><?php echo e(session('username')); ?></span></h2>
      <div>
    ...
    <section id="contact">
      <div class="container">
        ...
        <tr>
           ...
           <!--  <td><?php echo e($list[$i]['messageId']); ?></td>
            <td><?php echo e($list[$i]['username']); ?></td>
            <td><?php echo e($list[$i]['message']); ?></td> -->

            <td>
            <div style=" padding:15px"><?php echo e($list[$i]['admin_name']); ?></div></td>
            </div>
            <td><a href="<?php echo e(route('customer.messageedit', [$list[$i]['messageId']])); ?>"><?php echo e($list[$i]['admin_message']); ?></td>
            <td>
                <a href="<?php echo e(route('customer.messagedelete', [$list[$i]['messageId']])); ?>">Remove</a><br>
                <a href="/E-Pay/home/details/message/customer/<?php echo e($list[$i]['messageId']); ?>">Screenshot<br><br>
            </td>
        </tr>
...
</html><?php /**PATH F:\13th Semester\ATP 3\Laravel-Project Backup\laratest\resources\views/customer/messagelist.blade.php ENDPATH**/ ?>