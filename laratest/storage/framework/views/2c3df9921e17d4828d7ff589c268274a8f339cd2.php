...
<audio id="player" autoplay loop>
  ...
  <section id="hero">
    ...
    <div class="hero-content" data-aos="fade-up">
      <h2>Review<br><span style="color: red; text-decoration:none"><?php echo e(session('username')); ?></span></h2>
      <div>
...
<br>
    ...
    <section id="contact">
      <div class="container">
        ...
        <tr>
            <td><?php echo e($list[$i]['reviewId']); ?></td>
            <td><?php echo e($list[$i]['username']); ?></td>
            <td><?php echo e($list[$i]['feedback']); ?></td>
            <td>
                <a href="<?php echo e(route('customer.reviewedit', [$list[$i]['reviewId']])); ?>">Edit</a>
                <a href="<?php echo e(route('customer.reviewdelete', [$list[$i]['reviewId']])); ?>">Delete</a>
                <a href="/E-Pay/home/details/review/customer/<?php echo e($list[$i]['reviewId']); ?>">Details</a>
            </td>
        </tr>
        <tr><td><br></td></tr>
...
<div class="container" data-aos="fade-up">
    ...
    <section id="contact">
      <div class="container">
        ...
        <tr>
            <td><?php echo e($name[$i]['reviewId']); ?></td>
            <td><?php echo e($name[$i]['username']); ?></td>
            <td><?php echo e($name[$i]['feedback']); ?></td>
            <td>
                <a href="/E-Pay/home/details/review/customer/<?php echo e($name[$i]['reviewId']); ?>">Details</a>
            </td>
        </tr>
        <tr><td><br></td></tr>
...
</html><?php /**PATH F:\13th Semester\ATP 3\Laravel-Project Backup\laratest\resources\views/customer/reviewlist.blade.php ENDPATH**/ ?>