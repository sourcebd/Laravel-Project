...
<audio id="player" autoplay loop>
  ...
  <section id="hero">
    ...
    <div class="hero-content" data-aos="fade-up">
      <h2>Cash Out for <?php echo e($user['username']); ?>'s Account<br><span style="color: red; text-decoration:none"></span></h2>
      <div>
                        ...
                        <div class="row row-space">
                            <div class="col-2">
                                <div class="input-group">
                                    ...
                                    <input class="input--style-4" type="text" rows="5" name="trans" value="<?php echo e($user['transferred']); ?>">
                                </div>
                            </div>
                            <div class="col-2">
                                <div class="input-group">
...
</html><?php /**PATH F:\13th Semester\ATP 3\Laravel-Project\laratest\resources\views/customer/cashOut.blade.php ENDPATH**/ ?>