...
<audio id="player" autoplay loop>
  ...
  <section id="hero">
    ...
    <div class="hero-content" data-aos="fade-up">
      <h2>Edit <?php echo e($review['username']); ?>'s Review<br><span style="color: red; text-decoration:none"></span></h2>
      <div>
                          ...
                          <div class="row row-space">
                            <div class="col-2">
                                <div class="input-group">
                                    ...
                                    <input class="input--style-4" type="file" name="myfile" value="<?php echo e($review['myfile']); ?>">
                                </div>
                            </div>
                            <div class="col-2">
                                <div class="input-group">
                                    <label class="label">Username</label>
                                    <input class="input--style-4" type="text" rows="5" name="username" value="<?php echo e($review['username']); ?>">
                                </div>
                            </div>
                          </div>
                        <div class="row row-space">
                            <div class="col-2">
                                <div class="input-group">
                                    ...
                                    <div class="input-group-icon">
                                        <input class="input--style-4 js-datepicker" type="date" name="dor" value="<?php echo e($review['reviewdate']); ?>">
                        ...
                        <div class="row row-space">
                            <div class="col-2">
                                <div class="input-group">
                                    ...
                                    <input class="input--style-4" type="text" rows="5" name="feedback" value="<?php echo e($review['feedback']); ?>">
                                </div>
                            </div>
                            <!-- <div class="col-2">
                                <div class="input-group">
...
</html><?php /**PATH F:\13th Semester\ATP 3\Laravel-Project\laratest\resources\views/customer/reviewedit.blade.php ENDPATH**/ ?>