...
<head>
  ...
  <title>E-Pay | Customer-Purchase Details</title>
...
<audio id="player" autoplay loop>
  ...
  <section id="hero">
    ...
    <div class="hero-content" data-aos="fade-up">
      <h2><?php echo e($user['username']); ?>'s Purchase Details<br><span style="color: red; text-decoration:none"></span></h2>
      <div>
    ...
    <section id="contact">
      <div class="container">
        ...
        <tr>
					...
					<td><?php echo e($user['card_no']); ?></td>
					<td><?php echo e($user['bank_name']); ?></td>
					<td>৳<?php echo e($user['loan']); ?></td>
          <td>৳<?php echo e($user['mobile_recharge']); ?></td>
          <td>৳<?php echo e($user['electricity_bill']); ?></td>
					<td>৳<?php echo e($user['total_purchased']); ?></td>
        </tr>
...
</html><?php /**PATH F:\13th Semester\ATP 3\Laravel-Project\laratest\resources\views/customer/purchasedetails.blade.php ENDPATH**/ ?>