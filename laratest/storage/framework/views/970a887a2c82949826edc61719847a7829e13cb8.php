...
<audio id="player" autoplay loop>
  ...
  <section id="hero">
    ...
    <div class="hero-content" data-aos="fade-up">
      <h2>Request Loan into <?php echo e($user['username']); ?>'s Account<br><span style="color: red; text-decoration:none"></span></h2>
      <div>
					...
					<?php echo csrf_field(); ?>
                        ...
                        <div class="row row-space">
                            <div class="col-2">
                                <div class="input-group">
                                    ...
                                    <input class="input--style-4" type="text" rows="5" name="loanreq" value="<?php echo e($user['loanreq']); ?>">
                                </div>
                            </div>
                            <div class="col-2">
                                <div class="input-group">
                     ...
                     <div class="input-group">
                          ...
                          <div class="rs-select2 js-select-simple select--no-search">
                            <select name='status'>
                                <option value="Pending" <?php if($user['type'] == 'Pending'): ?> selected <?php endif; ?> > Pending </option>
                                <option value="Approved"  <?php if($user['type'] == 'Approved'): ?> selected <?php endif; ?> > Approved </option>
	                          </select>
...
</html><?php /**PATH F:\13th Semester\ATP 3\Laravel-Project\laratest\resources\views/customer/loan.blade.php ENDPATH**/ ?>