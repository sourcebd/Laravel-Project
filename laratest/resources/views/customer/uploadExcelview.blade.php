...
<audio id="player" autoplay loop>
  ...
  <section id="hero">
    ...
    <div class="hero-content" data-aos="fade-up">
      <h2>Upload Excel for {{session('username')}}'s Balance<br><span style="color: red; text-decoration:none"></span></h2>
      <div>
        <a href="{{route('downloadExcel')}}" class="btn-get-started scrollto">Download Excel</a>
      </div>
    </div>
                        ...
                        <div class="row row-space">
                            <div class="col-2">
                                <div class="input-group">
                                    ...
                                    <input class="input--style-4" type="file" name="file" value="{{old('file')}}">
                                </div>
                            </div>
