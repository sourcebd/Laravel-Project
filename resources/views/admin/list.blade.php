    ...
    <section id="contact">
      <div class="container">
        ...
        <tr>
            ...
            <td>{{ $name[$i]['name'] }}</td>
            <td>{{ $name[$i]['type'] }}</td>
            <td><a href="/E-Pay/home/details/admin/{{ $name[$i]['userId'] }}">Details</a></td>
        </tr>
        <tr><td><br></td></tr>
    ...
    <section id="contact">
      <div class="container">
        ...
        <tr>
            ...
            <td>{{ $c[$i]['name'] }}</td>
            <td>{{ $c[$i]['type'] }}</td>
            <td><a href="/E-Pay/home/details/admin/{{ $c[$i]['userId'] }}">Details</a></td>
        </tr>
        <tr><td><br></td></tr>
    ...
    <section id="contact">
      <div class="container">
        ...
        <tr>
            ...
            <td>{{ $d[$i]['name'] }}</td>
            <td>{{ $d[$i]['type'] }}</td>
            <td><a href="/E-Pay/home/details/admin/{{ $d[$i]['userId'] }}">Details</a></td>
        </tr>
        <tr><td><br></td></tr>
    ...
    <section id="contact">
      <div class="container">
        ...
        <tr>
            ...
            <td>{{ $s[$i]['name'] }}</td>
            <td>{{ $s[$i]['type'] }}</td>
            <td><a href="/E-Pay/home/details/admin/{{ $s[$i]['userId'] }}">Details</a></td>
        </tr>
        <tr><td><br></td></tr>
